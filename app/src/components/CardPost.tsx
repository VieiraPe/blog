...
export default function CardPost() {
    return (
        <Link href="/post" className="w-full sm:max-w-88 h-full flex flex-col items-center gap-2 sm:gap-4 justify-between hover:brightness-75 transition-all">
            <div className="flex w-full h-50 sm:h-58.5 relative rounded-2xl overflow-hidden">
                <Image
            ...
            <div className="flex w-full flex-1 flex-col justify-between gap-1 sm:gap-2">
                <h2 className="font-bold text-lg sm:text-xl text-blue-600 text-center md:text-left">Como desenvolver um blog</h2>
                <p className="text-zinc-600 hidden md:flex flex-1 text-justify lg:text-left text-sm">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quam accusamus culpa voluptas expedita. Temporibus minus atque nostrum et natus! Cum maiores cupiditate laudantium distinctio voluptas, esse saepe assumenda. Vel, ipsa!</p>
                <div>
