...
export default function Post() {
    return (
        <div className="w-full max-w-280 flex flex-col mx-auto pb-12">
            <Header />
            <Link href="/" className="flex w-full max-w-fit px-4 font-bold text-zinc-900 hover:text-zinc-600">
            ...
            <div className="w-full h-full flex flex-col mt-8">
                <div className="flex w-full h-95.5 relative rounded-2xl overflow-hidden">
                    <Image
